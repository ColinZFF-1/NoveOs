...
class SceneWriterStep(PipelineStep):
    ...
    def _call_scene_writer_half(
        ...
        temp, max_tok = get_agent_llm_params(ctx.book_config, "scene_writer", 0.75, 12000)
        log_full_prompt(f"scene_writer_{half}", chapter_num, dna, user)
    ...
    def merge(self, ctx: ChapterContext, draft_first: str, draft_second: str) -> str:
        ...
        temp, max_tok = get_agent_llm_params(ctx.book_config, "merger", 0.3, 12000)
        log_full_prompt("merger", chapter_num, system, user)
